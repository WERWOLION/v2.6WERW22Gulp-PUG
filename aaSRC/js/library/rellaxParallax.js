export function rellaxParallax(){  // https://github.com/dixonandmoe/rellax

  //w Настройка внизу
  // This is the default setting
  // let rellax = new Rellax('.rellax', {breakpoints: [576, 768, 1201] });
  // div class="rellax" data-rellax-speed="7" data-rellax-zindex="5"
  // let rellax = new Rellax('.rellax', {horizontal: true , vertical: false });
